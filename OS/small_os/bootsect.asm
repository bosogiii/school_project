...
; (588kbytes) is set aside to be used for launching "MYOSKOS" image file.
;===============================================================================
...
.read_next_fat_dir:
		...
		; find Myosk os image file from directory table
		mov		cx, 224
		mov		bx, 1400h
...
.load_kernel:
		...
		mov		ax, LDRSEG
		mov		ds, ax
		jmp		LDRSEG:1000h			; jump to MYoskOS
...
;===============================================================================
msg_loading	db	'MYOSKOS LOADING.........', 00h
msg_dot		db	'.', 00h
msg_error	db	'Error! Do Not Read....', 00h
str_kernel	db	'MYOSKOS BIN'
