...
typedef enum {IfK,ReturnK,IterK,CompK} StmtKind;
typedef enum {OpK,ConstK,IdK,ArrIdK,AssignK,CallK} ExpKind;
typedef enum {FuncDeclK,VarDeclK,ArrDeclK} DeclKind;
